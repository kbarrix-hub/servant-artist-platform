...
final class SAP_Loader {
	...
	* Startup Order:
	...
	require_once dirname( __DIR__ ) . '/harmony/document/class-sap-harmony-document.php';

    require_once dirname( __DIR__ ) . '/harmony/document/class-sap-harmony-document-store.php';
	...
	require_once dirname( __DIR__ ) . '/harmony/ajax/class-sap-harmony-ajax-controller.php';
	...
	require_once dirname( __DIR__ ) . '/ui/sections/song/class-sap-song-statistics-section.php';
	...
	require_once dirname( __DIR__ ) . '/ui/sections/profile/class-sap-profile-bio-section.php';

	require_once dirname( __DIR__ ) . '/ui/sections/profile/class-sap-profile-info-section.php';
